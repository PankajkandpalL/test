...
function ContextProvider({children}){
    ...
    return (<contextApi.Provider value={{handleNewText,newText,handleUpdate,handDeleteDoctor,handleSort,handleFilter,handlePage,doctorDetail,getDoctorDetails,doctorsData,postDoctorData,formArr,handleDoctorFormData,handleFormData,postHospitalData,hospitalData}} >{children}</contextApi.Provider>)
}
